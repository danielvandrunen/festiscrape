...
export async function scrapeFestivalLineup(url: string): Promise<Festival> {
  ...
  try {
    ...
    return {
      id: '', // This should be generated by the caller
      name: festivalName,
      date: new Date(), // This should be extracted from the page
      website: url,
      num_acts: artists.length,
      locations: [], // This should be extracted from the page
      status: 'active',
      is_interested: false,
      is_favorite: false,
      source: 'festileaks', // This should be determined based on the URL
