...
import { PartyflockScraperSimple } from '@/lib/scrapers/partyflock-scraper-simple';
...
export async function POST(request: NextRequest) {
  try {
    console.log('Starting Partyflock scraping process (simple version)...');
    ...
    console.log('Running Partyflock scraper (simple version)...');
    let festivals;
    try {
